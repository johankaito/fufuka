...
# dgTest = Graph(directed=True)
# n1 = dgTest.add_vertex()
# t1 = dgTest.add_vertex()
# n4 = dgTest.add_vertex()
# n5 = dgTest.add_vertex()
# t4 = dgTest.add_vertex()

# e1 = dgTest.add_edge(n1, t1)
# e2 = dgTest.add_edge(t1, n4)
# e3 = dgTest.add_edge(t1, n5)
# e4 = dgTest.add_edge(n4, t4)

# v_prop = dgTest.new_vertex_property("string")
# v_prop[n1] = 'node1'
# v_prop[t1] = 't1'
# v_prop[n4] = 'node4'
# v_prop[n5] = 'node5'
...
# #graph_draw(dgTest, vertex_text=dgTest.vertex_index, vertex_font_size=18,output_size=(200, 200), output="two-nodes.png")
# graph_draw(
# 	dgTest, 
# 	vertex_text=v_prop, 
# 	vertex_font_size=10,
# 	output_size=(500, 500), 
# 	output="many-nodes.png"
# 	)
